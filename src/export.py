...
def export_chart_images(engine, start_date, end_date, customer=None, contract=None, show_gridlines=False):
    # Generate charts
    visualization.create_mrr_change_chart(engine, start_date, end_date, customer, contract)
    visualization.create_monthly_mrr_chart(engine, start_date, end_date, customer, contract, show_gridlines)
    visualization.ttm_ndr_gdr_chart(engine, end_date, customer, contract)
    visualization.create_bookings_arr_carr_chart(engine, start_date, end_date, customer, contract, show_gridlines)
