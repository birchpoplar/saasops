-- Case 3
-- Single 12-Month Contract, $120k, renewed at end with half ARR $60k
...
INSERT INTO Contracts (CustomerID, Reference, ContractDate, TermStartDate, TermEndDate, TotalValue, RenewalFromContractID) VALUES (1, 'Test-Contract2', '2023-05-01', '2023-06-01', '2024-05-31', 60000, 1);
...
INSERT INTO Segments (ContractID, Title, SegmentStartDate, SegmentEndDate, Type, SegmentValue) VALUES (2, 'Test-Segment2', '2023-06-01', '2024-05-31', 'Subscription', 60000);

-- Invoices
INSERT INTO Invoices (Number, Date, DaysPayable, Amount) VALUES ('Test-Invoice1', '2022-05-01', 0, 120000);
INSERT INTO Invoices (Number, Date, DaysPayable, Amount) VALUES ('Test-Invoice2', '2023-05-01', 0, 60000);
